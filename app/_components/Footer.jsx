        ...
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/5">
            <a href="/" className="block w-56 mb-10">
              <Image src="/Multimax_Store_logo.png" alt="logo" width={150} height={150} />
            </a>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Links</h2>
            </div>
            <ul className="leading-8">
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Conecta con Nosotros</h2>
            </div>
